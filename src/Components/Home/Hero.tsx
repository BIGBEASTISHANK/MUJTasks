      ...
      >
        ...
        >
          <span className="text-[#1793D1] font-bold text-lg md:text-xl mx-8 flex items-center">
            ⚠️ Website is disabled due to year breaks - We'll be back soon!
          </span>
        ...
        >
          <div className="mb-6">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white">
              <span className="text-[#1793D1]">MUJ Tasks</span> - Your Academic
              Solution
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Don't let assignments, lab manuals & projects overwhelm your
              college experience
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-[#1A1E23] p-5 rounded-xl shadow-md hover:shadow-[#1793D1]/20 hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Get expertly crafted assignments/projects from our skilled
                  writers/coders who understand MUJ requirements.
                </p>
              </div>
              <div className="bg-[#1A1E23] p-5 rounded-xl shadow-md hover:shadow-[#1793D1]/20 hover:scale-105 transition-all duration-300">
                <h3 className="text-xl font-bold mb-2 text-[#1793D1]">
                ...
                <p className="text-gray-300">
                  Never miss a deadline again. We prioritize timely submissions
              ...
              <div className="bg-[#1A1E23] p-5 rounded-xl shadow-md hover:shadow-[#1793D1]/20 hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Focus on what matters to you while we handle your academic
                  workload.
                </p>
              </div>
            </div>
